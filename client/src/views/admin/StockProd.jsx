...
import { Table, Thead, Tbody, Tfoot, Box, Tr, Th, TableCaption, InputGroup, InputLeftElement, Input } from "@chakra-ui/react";
    ...
    return (
        <Box mt="100px" alignItems="center">
            <InputGroup w={{ base: "80%", md: "40%" }} display="flex" m="30px auto">
                ...
                <Input placeholder="Search for articles..." value={searchVal} onChange={(e) => handleSearch(e.target.value)} />
            </InputGroup>
            <AddProduct setNData={setNData} setData={setData}  />
            <Table variant="simple">
                ...
                <Tbody fontWeight="bold">
                    {Ndata.length > 0 && Ndata.map((product, i) => <ManageStock product={product} key={i} />)}
                </Tbody>
                <Tfoot>
                    <Tr>
                        <Th display={["none", "table-cell"]}></Th>
