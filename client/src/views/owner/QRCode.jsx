    ...
    return (
        <Grid gap={2} padding={5} margin="30px 100px">
            ...
            <Text color="gray.600" fontSize="2xl">
                Los codigos QR llevaran a tus clientes al menu del restaurant, luego de escanearlos con sus telefonos. Generarlos
                descargara un pdf con todos los codigos deseados, a partir de ahi podes imprimirlos.
            </Text>
            <br />
            <Box display="flex" padding={5} border="1px solid black" borderRadius="5px">
                <Box w="50%">
                    <Text mb={12}>
                        El codigo QR general llevara a tus clientes al mismo link independientemente de la mesa, ideal si no
                        usaras la funcion de pedidos por medio de la app.
                    </Text>
                    <Button colorScheme="blue" onClick={saveGeneral}>
                        General
                    </Button>
                </Box>
                <Box w="50%">
                    <Text mb={5}>
                        Si queres generar un codigo por cada mesa para poder hacer uso del sistema de pedidos, ingresa el numero
                        de mesas deseadas y se generaran tantos codigos como mesas. Asegurate de que cada codigo permanezca en la
                        mesa que le corresponde.
                    </Text>
                    <Box display="flex">
                        <InputGroup>
                            <Input
                            ...
                            <Button ml={10} onClick={saveTables} colorScheme="blue" variant="outline">
                                Por mesa
                            </Button>
                        </InputGroup>
                    </Box>
